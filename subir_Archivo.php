<?php
	...
	IF(ISSET($_POST["submit"])){
		...
		if ($ImagenFileType=="xlsx" || $ImagenFileType=="xlx"){
			echo "El archivo es un xls o xlsx </BR>";
			///INSERT INTO `usuarios` (`id_Usuario`, `Nombre_Usuario`, `Foto`) VALUES (NULL, 'mm', 'mm');
			move_uploaded_file ($archivoOrigen,$archivoDestino);
			$query = "INSERT INTO usuarios (id_Usuario, Nombre_Usuario, Foto) VALUES (NULL, 'Cos', 'Cos')";
